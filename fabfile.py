...
env.roledefs = {
    'myserver': ['secsin@127.0.0.1:6666'],
}
env.PROJECT_NAME = 'typeidea'
env.SETTINGS_BASE = 'typeidea/typeidea/settings/base.py'
env.DEPLOY_PATH = '/home/secsin/.virtualenvs/typeidea-env'
...
def build(version=None):
    ...
    with settings(warn_only=True):
        local('python setup.py bdist_wheel upload -r mypypi')
...
def _ensure_virtualenv():
    ...
    run('python3.7 -m venv %s' % env.DEPLOY_PATH)
